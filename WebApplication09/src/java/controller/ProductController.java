    ...
    private String handleProductAdding(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (AuthUtils.isAdmin(request)) {
            ...
            if (price_value < 0) {
               ...
               request.setAttribute("priceError", "Thid product price must be larger than 0");
            }
            ...
            //gui 1 object ten product tu Servlet den jsp
            // o form , jsp, tao doi tuong de chua
        }
